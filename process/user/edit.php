<div class="container">
  ...
  <div class="row mt-4" style="margin-left: 10px; margin-right: 10px">
    ...
    <div class="card shadow mb-5" style="box-shadow: 10px; border-radius: 10px; border: none">
        <div class="card-body">
          <div class="row">
            <div class="col-2 title ps-0 float-start" style=" border-bottom: 2px solid #ff7f5c; width: 140px; font-size: 15px; ">Form Edit Admin
            </div>
          </div>   
		<?php 
      ...
      <div class="col mt-4">
          <form action="?p=user.action" id="defaultForm" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="uname" name="uname" value="<?php echo $data['uname'];?>" required />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="nip" class="form-label">NIP</label>
                <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" id="nip" name="nip" value="<?php echo $data['nip'];?>" required/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="nohp" class="form-label">No. HP / Telepon</label>
                <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="form-control" id="nohp" name="nohp" value="<?php echo $data['nohp'];?>" required/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="file" name="foto" value="<?php echo $data['foto'];?>" class="form-control" /><br><img src="assets/img/admin/<?php echo $data['foto'];?>" width="90" height="90"/>
            </div>
            <div class="my-4">
