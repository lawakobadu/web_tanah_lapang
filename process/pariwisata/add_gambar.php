      ...
      <div class="col mt-4">
       ...
       <?php 
        ...
        ?>
          ...
          <div class="my-4">
            <button type="submit" name="add_gambar" class="btn px-5 py-2 float-end" style="background-color: #ff7f5c; color: #fff; font-size: 14px; font-weight: bold; border-radius: 10px;"
