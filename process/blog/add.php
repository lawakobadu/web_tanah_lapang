<div class="container">
  ...
  <div class="row mt-4" style="margin-left: 10px; margin-right: 10px">
    ...
    <div class="card shadow-sm mb-5" style="box-shadow: 10px; border-radius: 10px; border: none"> 
      <div class="card-body">
        <div class="row">
            <div class="col-2 title ps-0 float-start" style=" border-bottom: 2px solid #ff7f5c; width: 200px; font-size: 15px; "> Form Tambah Blog
            </div>
          </div>
      <div class="col mt-4">
        ...
        <form action="?p=blog.action" id="defaultForm" method="post" enctype="multipart/form-data">
          <div class="mb-3">
            <label for="judulBlog" class="form-label">Judul Blog</label>
              <input type="text" class="form-control" id="judulBlog" name="judul" required />
          </div>
          <div class="mb-3">
            <label for="tanggal" class="form-label">Tanggal</label>
              <input type="text" value="<?php echo date('Y-m-d')?>" class="form-control" id="tanggal" name="tanggal" readonly/>
          </div>
          <div class="mb-3">
            <label for="author" class="form-label">Author</label>
              <input type="text" class="form-control" id="author" value="<?php echo $_SESSION['nama']?>" name="author" readonly/>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="isi" class="form-label">Isi</label>
              <textarea class="form-control" id="isi" rows="20" name="isi" required></textarea>
          </div>
          <div class="my-4">
