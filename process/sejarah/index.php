  ...
  <div class="content p-4">
    ...
    <div class="row mt-4" style="margin-left: 10px; margin-right: 10px">
      ...
      <div class="card shadow mb-5"style="box-shadow: 10px; border-radius: 10px; border: none">
        <div class="card-body">
          <div class="row">
            <div class="col-2 title ps-0 float-start" style="border-bottom: 2px solid #ff7f5c; width: 70px;font-size: 15px;">Sejarah
        ...
        <div class="row">
          <div class="col mt-4">
            <form action="?p=sejarah.action" id="defaultForm" method="post" enctype="">
              <div class="mb-3">
                <textarea class="form-control" rows="20" id="sejarah" name ="sejarah" placeholder="Type here.."><?php echo $data['sejarah'];?></textarea>
              </div>
